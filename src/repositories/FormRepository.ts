...
export class FormRepository {
  ...
  public convertToModel(churchId: string, data: any) {
    const result: Form = { id: data.id, name: data.name, contentType: data.contentType, createdTime: data.createdTime, modifiedTime: data.modifiedTime, accessStartTime: data.accessStartTime, accessEndTime: data.accessEndTime, restricted: data.restricted, archived: data.archived, action: data.action, thankYouMessage: data.thankYouMessage };
    return result;
  }
